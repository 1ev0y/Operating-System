...
void mems_init(){
    linked_list_starting_address=mmap(NULL,PAGE_SIZE,PROT_READ | PROT_WRITE | PROT_EXEC , MAP_PRIVATE|MAP_ANONYMOUS ,-1,0);
...
void* mems_malloc(size_t size){
    ...
    //FINDS NUMBER OF PAGES TO ALLOCATE
    int pages=0;
