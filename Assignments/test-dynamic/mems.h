...
void mems_init(){
    ...
    linked_list_starting_address+=sizeof(struct main*);
    head->next=NULL;
    head->prev=NULL;
    head->pages=0;
    head->right=NULL;
...
void* mems_malloc(size_t size){
    void * ptr=linked_list_starting_address;
    ...
    if(iterator==NULL){
        ...
        printf("%lu\n",(unsigned long)ptr);
        struct main *new_main_node=(struct main*)ptr;
        ptr+=sizeof(struct main*);
        ...
        struct sub *new_sub_node_1=(struct sub*)ptr;
        ptr+=sizeof(struct sub*);
        printf("%lu\n",(unsigned long)ptr);

        
        struct sub *new_sub_node_2=(struct sub*)ptr;
        ptr+=sizeof(struct sub*);
        printf("%lu\n",(unsigned long)ptr);
