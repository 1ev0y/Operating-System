...
void mems_finish(){
    ...
    munmap((void *)head,(size_t)linked_size);
}
...
void* mems_malloc(size_t size){
    ...
    while(iterator!=NULL){
        ...
        while(sub_iterator!=NULL){
            ...
            if(sub_iterator->size>=size && sub_iterator->type=="HOLE"){
                ...
                struct sub *new_sub_node=(struct sub*)final_pointer;
    ...
    if(iterator==NULL){
        ...
        struct main *new_main_node=(struct main*)final_pointer;
        ...
        struct sub *new_sub_node_1=(struct sub*)final_pointer;
        final_pointer+=sizeof(struct sub);

        
        struct sub *new_sub_node_2=(struct sub*)final_pointer;
        final_pointer+=sizeof(struct sub);
